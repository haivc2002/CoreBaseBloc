                  ...
                  child: Column(
                    ...
                    children: [
                      if(showTitle) SizedBox(
                        ...
                        child: Text(title, style: styleTitle ?? textStyleWithCtx(context).bold.sSize(15).sColor(Colors.black), maxLines: 1),
                      ),
                      ...
                      if(showBottom) bottom ?? SizedBox(
                        ...
                        child: WidgetButton(
                          title: "Đóng",
                          contentStyle: textStyleWithCtx(context).sColor(Colors.white),
                          vertical: 7,
